...
const home = () => {
  return (
    <NativeBaseProvider>
      ...
      <View style={{flex:9, backgroundColor:"white", marginTop:3, }}>
      {/* <TouchableOpacity>
        <Icon name="notifications" size={33} color="#3AA346" />
      </TouchableOpacity> */}

        <Text bold  fontSize={30} ml={5} mr={5} >
          Find Your Doctor
        </Text>
        <Text ml={5} mr={5}>Book an appointment with Doctor</Text>

        <Box bgColor={'#bdbd'} mt={5} h={150} borderRadius={'10'} ml={5} mr={5}>
        ...
        <Box bgColor={'#bdbd'} mt={3} h={70} borderRadius={'10'} ml={5} mr={5} >
